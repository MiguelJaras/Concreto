...
public partial class Pages_Reportes_Consumos : System.Web.UI.Page
{
    ...
    public static string[] ShowReport(string datFechaInicio, string datFechaFin)
    {
        ...
        try
        {
            ...
            string strFileName = "Consumos_" + ClasicoConcreto.SEMSession.GetInstance.IntCliente + ".pdf";
            string PathReport = AppDomain.CurrentDomain.BaseDirectory + "Pages\\Reportes\\Consumo.rpt";
            string PathEnviar = AppDomain.CurrentDomain.BaseDirectory + "Temp\\Reporte Consumo\\" + strFileName;
