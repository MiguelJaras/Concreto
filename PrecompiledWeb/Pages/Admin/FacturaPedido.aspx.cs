...
public partial class Pages_Admin_FacturaPedido : BasePage
{
    private string strDirectoryTemp, strDirectory, strFileFacturaPDF, strFileFacturaXML;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnGuardar.Attributes.Add("onclick", "return Validar();");
    ...
    protected void GuardarFactura()
    {
        try
        {
            ...
            if (entFactura.strFactura == "") {
                throw new Exception("No se ha ingresado la factura.");
            }

            Facturas objFacturas = new Facturas();
            strPedido = txtPedido.Text;
            entFactura.strPedidos = strPedido;
