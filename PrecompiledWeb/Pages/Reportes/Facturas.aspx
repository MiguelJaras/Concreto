<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/site.master" AutoEventWireup="true" CodeFile="Facturas.aspx.cs" Inherits="Pages_Reportes_Facturas" %>
    ...
    <script type="text/javascript">
        ...
        function Exportar() {
            ...
            if (reporte == 'pdf') {
                ...
                window.open('../../Utils/Excel.aspx?type=Facturas&params=' + strFechaInicio + ',' + strFechaFin);
            }
        }


        function ShowPDF(fechaInicio, fechaFin) {
            var urlData = 'Facturas.aspx/ShowReport';
        ...
        function ShowModalPDF(fileName) {
            ...
            htmlContent = htmlContent.replace(/{FileName}/g, "../../Temp/Reporte Facturas/" + fileName);
