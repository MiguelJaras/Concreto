...
public partial class Pages_Reportes_PedidoFactura : BasePage
{
    ...
    public static string[] ShowReport(string datFechaInicio, string datFechaFin)
    {
        ...
        try
        {
            ...
            string strFileName = "PedidoFactura_" + ClasicoConcreto.SEMSession.GetInstance.IntCliente + ".pdf";
            string PathReport = AppDomain.CurrentDomain.BaseDirectory + "Pages\\Reportes\\PedidoFactura.rpt";
            string PathEnviar = AppDomain.CurrentDomain.BaseDirectory + "Temp\\Reporte Remisiones\\" + strFileName;
