<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/site.master" AutoEventWireup="true" CodeFile="Consumos.aspx.cs" Inherits="Pages_Reportes_Consumos" %>
    ...
    <script type="text/javascript">
        ...
        function Exportar() {
            ...
            if (reporte == 'pdf') {
                ...
                window.open('../../Utils/Excel.aspx?type=Consumos&params=' + strFechaInicio + ',' + strFechaFin);
            }
        }


        function ShowPDF(fechaInicio, fechaFin) {
            var urlData = 'Consumos.aspx/ShowReport';
        ...
        function ShowModalPDF(fileName) {
            ...
            htmlContent = htmlContent.replace(/{FileName}/g, "../../Temp/Reporte Consumo/" + fileName);
